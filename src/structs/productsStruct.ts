...
export const ProductIdParamStruct = object({
  productId: nonempty(string()),
});

export const DeleteProductBodyStruct = object({
  reason: nonempty(string()),
});

export const BulkUpdateProductsBodyStruct = object({
  productIds: array(nonempty(string())),
  updateData: UpdateProductBodyStruct,
});